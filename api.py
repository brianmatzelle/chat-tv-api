...
#     #@ CHAT GPT @#
#     def get(self):
#         if request.args.get('model') == 'gpt-3.5-turbo' or request.args.get('model') == 'gpt-4':
#             for _ in range(MAX_RETRIES):  # You need to define MAX_RETRIES
#                 try:
#                     response = openai.ChatCompletion.create(
#                         model=request.args.get('model'),
#                         # messages=self.memory,
#                         messages=request.args.get('memory')
#                         max_tokens=,
#                         temperature=1,
#                         # top_p=top_p,
#                     )
...
#                     prompt=f'{request.args.get("context")}\n{request.args.get("streamer_name")}: {request.args.get("input_text")}\n{request.args.get("bot_name")}:',
#                     temperature=1,
#                     max_tokens=25,
#                     )
